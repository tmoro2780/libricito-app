...
const faqsDefault = [
    {
        q: "¿Cómo creo una cuenta en Librisito?",
    ...
    },
    {
        ...
        a: "En la página del local vas a encontrar sus datos de contacto y un botón para enviar consultas directamente desde Librisito.",
    },
];
    ...
    return (
        ...
        <div className="mx-auto max-w-6xl px-8 sm:px-10 lg:px-12 my-24">
            ...
            <p className="mt-3 text-gray-600">
                Resolvé dudas rápidas sobre cómo usar Librisito.
            </p>
            </div>
