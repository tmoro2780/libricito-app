    ...
    <main className="w-full">
        ...
        <section className="bg-white">
            ...
            <div className="mx-auto max-w-3xl text-center">
                ...
                Sobre <span className="text-rose-600">Librisito</span>
                </h1>
                <p className="mt-4 text-lg text-gray-700">
                Librisito es una plataforma que conecta lectores con librerías
        ...
        <section className="bg-rose-50/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                <p className="mt-4 text-gray-700">
                    ...
                    personalizada y la comunidad lectora. Librisito reúne todo en un
